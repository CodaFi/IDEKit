...
@interface TextTabPrefsPane : IDEKit_PreferencePane {
    IBOutlet id myTabStops;
    IBOutlet id myTabStopsUnits;
    IBOutlet id mySaveUsing;
    IBOutlet id mySpacesPerTab;
    IBOutlet id mySpacesPerIndent;
    IBOutlet id myTextSample;
    IBOutlet id myTextName;
//    IBOutlet id myConvertSpaces;
}
