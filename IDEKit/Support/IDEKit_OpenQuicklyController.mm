...
- (NSDocument *) openQuicklyWithText: (NSString *) selection helper: (id <IDEKit_OpenQuicklyFinder>) helper context: (void *) context flags: (NSInteger) flags
{
	id document = [self openDocumentWithContentsOfURL:[NSURL URLWithString:selection] display:YES error:nil]; // see if it is full path
